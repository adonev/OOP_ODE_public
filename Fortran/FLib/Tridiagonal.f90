...
! void SolveTridiagonal(double *a, double *b, double *c, double *r, double *u, int n, bool periodic)
subroutine solve_tridiag(a,b,c,r,u,n,periodic) bind(C, name="SolveTridiagonal")
      implicit none      
